                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="tab1">
                                ...
                                <p>Eius alias aut cupiditate. Dolor voluptates animi ut blanditiis quos nam. Magnam
                                    officia aut ut alias
                                    quo explicabo ullam esse. Sunt magnam et dolorem eaque magnam odit enim quaerat.
                                    Vero error error
                                    voluptatem eum.</p>
...
.about .about-img:before {
    ...
    z-index: -1;
    content: "";
    background: url("@/assets/images/about-bg.png") top left;
