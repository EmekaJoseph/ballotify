            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-12  sideWriteUp">
                    <div class="container spanni">
                        ...
                        <div class="d-none d-md-block text-center newOrgBtn" @click="router.push({ name: 'SignUp' })">
                            ...
                            <div class="row gy-3">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input :class="{ 'formError': err.username }" v-model="form.username"
                                            type="text" class="form-control" id="floatUserName"
